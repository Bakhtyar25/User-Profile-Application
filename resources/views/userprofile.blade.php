...
<div class="container-fluid pb-3">
    <div class="d-grid gap-3 " style="grid-template-columns: 1fr 2fr;">
        <div class="text-warning border rounded-3 w-100 " style="height: auto; background-color: rgba(255, 255, 255, 0.155) !important ;" >
        ...
        <div class="bg-light border rounded-3 p-2 w-100 text-warning" style="height: auto; background-color: rgba(255, 255, 255, 0.155) !important ;">
            <p>
                <span class="fw-bold">Front End Developer </span> <br><br>
                <span class="fw-bolder">Degree:</span><br>&nbsp;&nbsp;&nbsp;undergraduate <br><br>
                <span class="fw-bolder">Language:</span><br>&nbsp;&nbsp;&nbsp;English <br>&nbsp;&nbsp;&nbsp;Kurdish <br>
                <br><span class="fw-bolder">Tools:</span><br>&nbsp;&nbsp;&nbsp;HTML <i class="fa fa-html5" style="font-size:20px"></i><br>&nbsp;&nbsp;&nbsp;CSS &nbsp;<i class="fa fa-css3" style="font-size:20px"></i>
